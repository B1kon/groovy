...
//      (for board MC127.05)                                                  //
//                                                                            //
// Copyright (c) 2019 RC Module                                               //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////

#ifndef __MC12705LOAD__H__
#define __MC12705LOAD__H__

#include <windows.h>

#define PLOAD_VERSION "1.0"
#define PLOAD_MAJOR_VERSION 1
#define PLOAD_MINOR_VERSION 0
...
extern "C" {
	...
	DECLSPEC int PL_GetSerialNumber(PL_Board *board, unsigned long *serial_number);
	...
	// len     - Size of array
	// address - Address of source array in board memory
	...
	// len     - Size of array
	// address - Address of destination array in board memory
	...
	// address	- Address of register to read in processor address space
	...
	// address	- Address of register to write in processor address space
